...
def scan_xss(url):
    ...
    try:
        ...
        if payload in r.text:
            print(f"{GREEN}[!] Possible XSS vulnerability detected at: {test_url}{RESET}")
        else:
...
def scan_cmd_injection(url):
    ...
    try:
        ...
        if "vulnXtest" in r.text:
            print(f"{GREEN}[!] Possible Command Injection vulnerability detected at: {test_url}{RESET}")
        else:
...
def scan_open_redirect(url):
    ...
    try:
        ...
        if "Location" in r.headers and redirect_test in r.headers["Location"]:
            print(f"{GREEN}[!] Possible Open Redirect vulnerability detected at: {test_url}{RESET}")
        else:
...
def main():
    ...
    url = input(f"{GREEN}Enter target URL (e.g. http://example.com): {RESET}").strip()
